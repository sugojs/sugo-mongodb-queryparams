...
var grammar = {
    ...
    {"name": "EXPRESSION", "symbols": ["KEY", "SEPARATOR", "OPERATOR", "SEPARATOR", "VALUE"], "postprocess":  function(d) { 
    ...
    {"name": "OPERATOR$string$1", "symbols": [{"literal":"e"}, {"literal":"q"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "OPERATOR", "symbols": ["OPERATOR$string$1"], "postprocess": function() { return "$eq" }},
    {"name": "OPERATOR$string$2", "symbols": [{"literal":"n"}, {"literal":"e"}, {"literal":"q"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "OPERATOR", "symbols": ["OPERATOR$string$2"], "postprocess": function() { return "$ne" }},
    {"name": "OPERATOR$string$3", "symbols": [{"literal":"g"}, {"literal":"t"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "OPERATOR", "symbols": ["OPERATOR$string$3"], "postprocess": function() { return "$gte" }},
    {"name": "OPERATOR$string$4", "symbols": [{"literal":"l"}, {"literal":"t"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "OPERATOR", "symbols": ["OPERATOR$string$4"], "postprocess": function() { return "$lte" }},
    {"name": "OPERATOR$string$5", "symbols": [{"literal":"g"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "OPERATOR", "symbols": ["OPERATOR$string$5"], "postprocess": function() { return "$gt" }},
    {"name": "OPERATOR$string$6", "symbols": [{"literal":"l"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
